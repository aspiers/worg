...
#+END_SRC
  ...
  document todo entries, *C-c / t* will show only your current todos,
...
* Becoming proficient with org-mode
  ...
  For quick reminders there are the [[https://orgmode.org/orgcard.pdf][org-mode cheat-sheet]] and the
